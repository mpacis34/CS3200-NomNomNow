...
CREATE ALL USER 'nomnomnowAdmin'@'%' IDENTIFIED BY 'bnD50!9OH2f';
GRANT ALL PRIVILEGES ON nomnomnow_db.* TO 'nomnomnowAdmin'@'%';
FLUSH PRIVILEGES
...
insert into DeliveryDriver (driver_id, first_name, last_name, phone_number, delivery_range_in_miles, starting_hour, ending_hour, start_date) values (1, 'Matthieu', 'Credland', '571-438-4983', 1, 1, 1, '5/2/2022');
insert into DeliveryDriver (driver_id, first_name, last_name, phone_number, delivery_range_in_miles, starting_hour, ending_hour, start_date) values (2, 'Renate', 'Dutson', '409-952-7694', 2, 2, 2, '5/29/2022');
insert into DeliveryDriver (driver_id, first_name, last_name, phone_number, delivery_range_in_miles, starting_hour, ending_hour, start_date) values (3, 'Estrellita', 'Lucas', '246-151-8890', 3, 3, 3, '2/10/2022');
insert into DeliveryDriver (driver_id, first_name, last_name, phone_number, delivery_range_in_miles, starting_hour, ending_hour, start_date) values (4, 'Sigrid', 'Scotsbrook', '331-623-7952', 4, 4, 4, '10/21/2022');
insert into DeliveryDriver (driver_id, first_name, last_name, phone_number, delivery_range_in_miles, starting_hour, ending_hour, start_date) values (5, 'Sada', 'Lishman', '813-706-5643', 5, 5, 5, '8/5/2022');
insert into DeliveryDriver (driver_id, first_name, last_name, phone_number, delivery_range_in_miles, starting_hour, ending_hour, start_date) values (6, 'Naoma', 'Kemme', '466-695-8296', 6, 6, 6, '10/13/2022');
insert into DeliveryDriver (driver_id, first_name, last_name, phone_number, delivery_range_in_miles, starting_hour, ending_hour, start_date) values (7, 'Leeanne', 'Ravens', '469-351-4582', 7, 7, 7, '10/2/2022');
insert into DeliveryDriver (driver_id, first_name, last_name, phone_number, delivery_range_in_miles, starting_hour, ending_hour, start_date) values (8, 'Kristopher', 'Iglesia', '375-327-1827', 8, 8, 8, '10/20/2022');
insert into DeliveryDriver (driver_id, first_name, last_name, phone_number, delivery_range_in_miles, starting_hour, ending_hour, start_date) values (9, 'Hans', 'Pellamont', '955-365-1244', 9, 9, 9, '10/13/2022');
insert into DeliveryDriver (driver_id, first_name, last_name, phone_number, delivery_range_in_miles, starting_hour, ending_hour, start_date) values (10, 'Hamish', 'Wharf', '949-744-0308', 10, 10, 10, '9/11/2022');
...
insert into Payment (order_id, amount, method, date) values (1, 17.81, 'visa', '08/20/2022');
insert into Payment (order_id, amount, method, date) values (2, 45.61, 'mastercard', '04/19/2022');
insert into Payment (order_id, amount, method, date) values (3, 15.22, 'amex', '09/06/2022');
insert into Payment (order_id, amount, method, date) values (4, 39.41, 'mastercard', '06/17/2022');
insert into Payment (order_id, amount, method, date) values (5, 38.31, 'mastercard', '05/24/2022');
insert into Payment (order_id, amount, method, date) values (6, 34.24, 'visa', '05/28/2022');
insert into Payment (order_id, amount, method, date) values (7, 55.16, 'amex', '03/18/2022');
insert into Payment (order_id, amount, method, date) values (8, 48.48, 'discover', '11/27/2021');
insert into Payment (order_id, amount, method, date) values (9, 33.35, 'mastercard', '11/19/2022');
insert into Payment (order_id, amount, method, date) values (10, 36.37, 'visa', '08/11/2022');
...
insert into MenuItem (item_id, menu_id, food_category_name, name, description, price, availability) values (1, 1, '', '', '', 78, true);
insert into MenuItem (item_id, menu_id, food_category_name, name, description, price, availability) values (2, 2, '', '', '', 18, false);
insert into MenuItem (item_id, menu_id, food_category_name, name, description, price, availability) values (3, 3, '', '', '', 28, false);
insert into MenuItem (item_id, menu_id, food_category_name, name, description, price, availability) values (4, 4, '', '', '', 12, true);
insert into MenuItem (item_id, menu_id, food_category_name, name, description, price, availability) values (5, 5, '', '', '', 56, false);
insert into MenuItem (item_id, menu_id, food_category_name, name, description, price, availability) values (6, 6, '', '', '', 20, true);
insert into MenuItem (item_id, menu_id, food_category_name, name, description, price, availability) values (7, 7, '', '', '', 38, true);
insert into MenuItem (item_id, menu_id, food_category_name, name, description, price, availability) values (8, 8, '', '', '', 52, true);
insert into MenuItem (item_id, menu_id, food_category_name, name, description, price, availability) values (9, 9, '', '', '', 51, false);
insert into MenuItem (item_id, menu_id, food_category_name, name, description, price, availability) values (10, 10, '', '', '', 94, true);
...
insert into Restaurant (rest_id, name, country, state, city, street, zip, opening_hour, closing_hour, info) values (1, 'Linkbuzz', 'United States', 'Massachusetts', 'Boston', '53758 Utah Street', '02298', 1, 1, 'Chinese Restaurant');
insert into Restaurant (rest_id, name, country, state, city, street, zip, opening_hour, closing_hour, info) values (2, 'Omba', 'United States', 'Massachusetts', 'Newton', '9358 Graceland Lane', '02162', 2, 2, 'Italian Restaurant');
insert into Restaurant (rest_id, name, country, state, city, street, zip, opening_hour, closing_hour, info) values (3, 'Tazzy', 'United States', 'Massachusetts', 'Springfield', '02 Daystar Plaza', '01129', 3, 3, 'Thai Restaurant');
insert into Restaurant (rest_id, name, country, state, city, street, zip, opening_hour, closing_hour, info) values (4, 'Skinte', 'United States', 'Massachusetts', 'Boston', '69589 Crowley Street', '02298', 4, 4, 'Japanese Restaurant');
insert into Restaurant (rest_id, name, country, state, city, street, zip, opening_hour, closing_hour, info) values (5, 'Livetube', 'United States', 'Massachusetts', 'Springfield', '99718 Melby Place', '01105', 5, 5, 'Korean Restaurant');
insert into Restaurant (rest_id, name, country, state, city, street, zip, opening_hour, closing_hour, info) values (6, 'Oloo', 'United States', 'Massachusetts', 'Springfield', '3950 Ronald Regan Alley', '01114', 6, 6, 'Mexican Restaurant');
insert into Restaurant (rest_id, name, country, state, city, street, zip, opening_hour, closing_hour, info) values (7, 'Bluezoom', 'United States', 'Massachusetts', 'Springfield', '8779 Harbort Alley', '01114', 7, 7, 'American Restaurant');
insert into Restaurant (rest_id, name, country, state, city, street, zip, opening_hour, closing_hour, info) values (8, 'Realcube', 'United States', 'Massachusetts', 'New Bedford', '0412 Towne Circle', '02745', 8, 8, 'Seafood Restaurant');
insert into Restaurant (rest_id, name, country, state, city, street, zip, opening_hour, closing_hour, info) values (9, 'Zoonder', 'United States', 'Massachusetts', 'Newton', '4 Moose Crossing', '02162', 9, 9, 'Vietnamese Restaurant');
insert into Restaurant (rest_id, name, country, state, city, street, zip, opening_hour, closing_hour, info) values (10, 'Yacero', 'United States', 'Massachusetts', 'Boston', '7277 Brown Pass', '02283', 10, 10, 'Thai Restaurant');
